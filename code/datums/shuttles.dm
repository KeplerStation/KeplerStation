...
/datum/map_template/shuttle/emergency/asteroid
	...
	description = "A respectable mid-sized shuttle that first saw service shuttling crew to and from asteroid belt embedded facilities."
	credit_cost = 3000
...
/datum/map_template/shuttle/emergency/discoinferno
	suffix = "discoinferno"
	name = "Disco Inferno"
	description = "The glorious results of centuries of plasma research done by brave space-firefighters. This is the reason why you are here. Get on and dance like you're on fire, burn baby burn!"
...
/datum/map_template/shuttle/emergency/supermatter
	...
	\"This shuttle has very a very high safety record, according to ICC Officer Cadet Yins.\"\n\
	\"Are you sure?\"\n\
...
/datum/map_template/shuttle/emergency/goon
	suffix = "goon"
	name = "ERRS"
	description = "The Emergency Response and Rescue Shuttle (ERRS) is a shuttle that can handle larger crowd capacity, but has fewer onboard shuttle facilities."
	credit_cost = 500
...
/datum/map_template/shuttle/emergency/raven
	...
	description = "The Raven Battlecruiser is currently docked at a nearby ship bay awaiting a mission, this Battlecruiser has been reassigned as an emergency escape shuttle for currently unknown reasons. The Raven Battlecruiser should comfortably fit a medium to large crew size crew and is complete with all required facitlities including a state-of-the-art medical bay."
