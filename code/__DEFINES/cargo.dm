...
<<<<<<< HEAD
    list("supplypod", "supply pod", "A supply drop pod."),\
    list("bluespacepod", "bluespace supply pod" , "A bluespace supply pod. Teleports back to Head Office after delivery."),\
    list("centcompod", "\improper supply pod", "A supply pod, this one has been marked with Head Office's designations. Teleports back to Centcom after delivery."),\
    ...
    list("squadpod", "\improper MK. II supply pod", "A supply pod. This one has been marked the markings of some sort of elite strike team."),\
    list("cultpod", "bloody supply pod", "A supply pod covered in scratch-marks, blood, and strange runes."),\
