...
#define POD_STYLES list(\
    list("supplypod", "supply pod", "A Horizons supply drop pod."),\
    list("bluespacepod", "bluespace supply pod" , "A Horizons Bluespace supply pod. Teleports back to Central Distribution after delivery."),\
    list("centcompod", "\improper Horizons supply pod", "A Horizons supply pod, this one has been marked with Head Office's designations. Teleports back to Central Distribution after delivery."),\
    ...
    list("squadpod", "\improper MK. II supply pod", "A Horizons supply pod. This one has been marked the markings of some sort of elite strike team."),\
    list("cultpod", "bloody supply pod", "A Horizons supply pod covered in scratch-marks, blood, and strange runes."),\
