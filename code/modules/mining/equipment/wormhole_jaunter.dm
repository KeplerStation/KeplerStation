...
/obj/item/wormhole_jaunter
	...
	desc = "A single use device harnessing outdated wormhole technology, which sounds right up Horizons' alley. The wormholes it creates are unpleasant to travel through, to say the least.\nThanks to modifications provided by the Free Golems, this jaunter can be worn on the belt to provide protection from chasms."
