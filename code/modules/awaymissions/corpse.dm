...
/obj/effect/mob_spawn/human/commander/alive
	death = FALSE
	roundstart = FALSE
	job_description = "Commander"
	mob_name = "Commander"
	name = "sleeper"
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	flavour_text = "<span class='big bold'>You are a Commander!</span>"

/obj/effect/mob_spawn/human/nanotrasensoldier/alive
	death = FALSE
	roundstart = FALSE
	mob_name = "Private Security Officer"
	job_description = "Security"
	name = "sleeper"
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	faction = "nanotrasenprivate"
	flavour_text = "<span class='big bold'>You are a Private Security Officer!</span>"
