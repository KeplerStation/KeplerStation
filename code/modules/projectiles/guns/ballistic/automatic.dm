...
/obj/item/gun/ballistic/automatic/ar
	name = "\improper XV-ARG 'Boarder'"
	desc = "A robust assault rifle used by several militant fighting forces."
	icon_state = "arg"
	item_state = "arg"
	slot_flags = 0
	mag_type = /obj/item/ammo_box/magazine/m556
...
/obj/item/gun/ballistic/automatic/laser
	name = "laser rifle"
	desc = "Though sometimes mocked for the relatively weak firepower of their energy weapons, the logistic miracle of rechargeable ammunition has given companies a decisive edge over many a foe."
	icon_state = "oldrifle"
	item_state = "arg"
