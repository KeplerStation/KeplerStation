/obj/item/firing_pin
	...
	desc = "A small authentication device, to be inserted into a firearm receiver to allow operation. Safety regulations require all new designs to incorporate one."
