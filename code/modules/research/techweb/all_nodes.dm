...
/datum/techweb_node/biotech
	...
	design_ids = list("medicalkit", "chem_heater", "chem_master", "bscanner", "chem_dispenser", "sleeper", "vr_sleeper", "pandemic", "defibmount", "operating", "soda_dispenser", "beer_dispenser", "healthanalyzer", "blood_bag")
