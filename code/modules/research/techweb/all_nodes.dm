...
/datum/techweb_node/biotech
	...
	design_ids = list("medicalkit", "chem_heater", "chem_master", "chem_dispenser", "sleeper", "vr_sleeper", "pandemic", "defibmount", "operating", "soda_dispenser", "beer_dispenser", "healthanalyzer", "blood_bag", "bloodbankgen", "bscanner", "telescopiciv")
...
<<<<<<< HEAD
	design_ids = list("research_nanites", "purging_nanites", "metabolic_nanites", "stealth_nanites", "memleak_nanites","sensor_voice_nanites", "voice_nanites")
=======
...
>>>>>>> ec67a38093... Merge pull request #10330 from keronshb/keronnanite
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2000)
	export_price = 4000
