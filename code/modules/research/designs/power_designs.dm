...
/datum/design/inducer
	name = "Inducer"
	desc = "The TV-75 Electromagnetic Power Inducer can wirelessly induce electric charge in an object, allowing you to recharge power cells without having to remove them."
	id = "inducer"
...
/datum/design/inducercombat
	...
	desc = "The improved TV-8475 Electromagnetic Power Inducer can this one has been SCIENCED to allow for combat. It still comes printed with SCIENCED colors!"
	id = "combatinducer"
	build_type = PROTOLATHE
