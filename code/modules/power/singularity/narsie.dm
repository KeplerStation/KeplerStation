...
/obj/singularity/narsie/large/cult/proc/begin_the_end()
	sleep(50)
	priority_announce("An acausal dimensional event has been detected in your sector. Event has been flagged EXTINCTION-CLASS. Directing all available assets toward simulating solutions. SOLUTION ETA: 60 SECONDS.","Horizons Interdimensional Affairs", 'sound/misc/airraid.ogg')
	sleep(500)
	priority_announce("Simulations on acausal dimensional event complete. Deploying solution package now. Deployment ETA: ONE MINUTE. ","Horizons Interdimensional Affairs")
	sleep(50)
