...
/obj/item/paper/fluff/ruins/oldstation/protogun
	...
	non laser fire mode, can only fire one round before exhausting the energy cell, the weapon also remains prohibitively expensive, nonetheless Market Research fully believe this weapon \
