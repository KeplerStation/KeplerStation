...
/obj/item/paper/fluff/ruins/oldstation/protogun
	...
	non laser fire mode, can only fire one round before exhausting the energy cell, the weapon also remains prohibitively expensive, nonetheless market research indicates that this weapon \
...
/obj/item/paper/fluff/ruins/oldstation/report
	...
	radiation on station. Deduction, primarily detector was malfunctioning and was producing a radiation signal when there was none.<br><br>2: A data burst from a nearby Space \
