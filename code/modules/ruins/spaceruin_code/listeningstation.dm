...
/obj/item/paper/fluff/ruins/listeningstation/briefing
	...
	info = "<b>Mission Details</b>: You have been assigned to a newly constructed listening post constructed within an asteroid in ICC space to monitor their operations. Accurate intel is crucial to the success of our operatives onboard, do not fail us."
