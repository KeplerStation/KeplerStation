...
/datum/uplink_item/dangerous/flamethrower
	name = "Flamethrower"
	desc = "A flamethrower, fueled by a portion of highly flammable and stolen corporate biotoxins. \
	Make a statement by roasting the filth in their own greed. Use with caution."
...
/datum/uplink_item/support/reinforcement/saboteur_borg
	...
	desc = "A streamlined engineering cyborg, equipped with covert modules. Also incapable of leaving the welder in the shuttle. \
			...
			Its chameleon projector lets it disguise itself as a Horizons cyborg, on top it has thermal vision and a pinpointer."
...
/datum/uplink_item/device_tools/magboots
	...
	desc = "A pair of magnetic boots with a Syndicate paintjob that assist with freer movement in space or on-station \
			during gravitational generator failures. These reverse-engineered knockoffs of the \
...
/datum/uplink_item/role_restricted/oldtoolboxclean //kepler
