...
/obj/machinery/nuclearbomb/ui_data(mob/user)
	...
	var/second_status = exploded ? "Warhead triggered, thanks for flying Epsilon" : (safety ? "Safe" : "Engaged")
...
/obj/machinery/nuclearbomb/beer
	name = "nuclear fission explosive"
	desc = "Nuclear fission explosives are renowned for being cheap to produce and devastatingly effective. Signs explain that though this particular device has been decommissioned, every stanard station is equipped with an equivalent one, just in case. All Captains carefully guard the disk needed to detonate them - at least, the sign says they do. There seems to be a tap on the back."
	proper_bomb = FALSE
