...
/datum/station_goal/proc/send_report()
	priority_announce("Priority directive received. Project \"[name]\" details inbound.", "Incoming Priority Message", 'sound/ai/commandreport.ogg')
	print_command_report(get_report(),"Directive [pick(GLOB.phonetic_alphabet)] \Roman[rand(1,50)]", announce=FALSE)
	on_report()
