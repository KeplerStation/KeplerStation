...
/datum/reagent/drug/skooma/addiction_act_stage4(mob/living/M)
	...
	if(prob(50)) //This proc will be called about 200 times and the adjustOrganLoss() below only has to be called 40 times to kill. This will make surviving skooma addiction pretty rare without mannitol usage.
