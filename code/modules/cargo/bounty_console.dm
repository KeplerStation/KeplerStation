...
/obj/machinery/computer/bounty
	name = "corporate bounty console"
	desc = "Used to check and claim bounties offered by Horizons/the Interstellar Trade Consortium"
	icon_screen = "bounty"
...
/obj/item/paper/bounty_printout/Initialize()
	. = ..()
	info = "<h2>Horizons Cargo Bounties</h2></br>"
...
/obj/machinery/computer/bounty/ui_interact(mob/user)
	...
	var/datum/browser/popup = new(user, "bounties", "Corporate Bounties", 700, 600)
