...
/datum/bounty/item/medical/liver
	name = "Livers"
	description = "Multiple high-ranking diplomats have been hospitalized with liver failure after a recent meeting with Third Soviet Union ambassadors. Help us out, will you?"
	reward = 10000
	required_count = 3
...
/*/datum/bounty/item/medical/lizard_tail
	name = "Lizard Tail"
	description = "The Wizard Federation has made off with our supply of lizard tails. While we're is dealing with the wizards, can the station spare a tail of their own?"
	reward = 3000
...
/datum/bounty/item/medical/blood
	name = "Generic Blood"
	description = "Horizons' annual blood drive is back up to full speed, following the garlic incident. Good blood in good volumes accepted for Credit returns."
	reward = 3500
	required_count = 600
