/datum/bounty/item/science/boh
	name = "Bag of Holding"
	description = "Head Office would make good use of high-capacity backpacks. If you have any, please ship them."
	reward = 10000
	wanted_types = list(/obj/item/storage/backpack/holding)

/datum/bounty/item/science/tboh
	name = "Trash Bag of Holding"
	description = "Head Office would make good use of high-capacity trash bags. If you have any, please ship them."
	reward = 10000
	wanted_types = list(/obj/item/storage/backpack/holding)

/datum/bounty/item/science/bluespace_syringe
	name = "Bluespace Syringe"
	description = "Head Office would make good use of high-capacity syringes. If you have any, please ship them."
	reward = 10000
...
/datum/bounty/item/science/experimental_welding_tool
	...
	description = "A recent accident has left most of Horizons' welding tools damaged. Ship replacements to be rewarded."
	reward = 10000
	required_count = 3
...
/datum/bounty/item/science/cryostasis_beaker
	...
	description = "Chemists working for the ICC have discovered a new chemical that can only be held in cryostasis beakers. The only problem is they don't have any! Rectify this to receive payment."
	reward = 10000
...
/datum/bounty/item/science/floor_buffer
	...
	description = "One of Horizons' janitors made a small fortune betting on carp races. Now they'd like to commission an upgrade to their floor buffer."
	reward = 10000
