/datum/bounty/item/security/riotshotgun
	name = "Riot Shotguns"
	description = "Hooligans have boarded Head Office! Ship riot shotguns quick, or things are going to get dirty."
	reward = 5000
	required_count = 2
...
/datum/bounty/item/security/recharger
	name = "Rechargers"
	description = "The ICC military academy is conducting marksmanship exercises. They request that rechargers be shipped."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/security/practice
	...
	description = "The ICC Military Academy is conducting routine marksmanship exercises. The clown hid all the practice lasers, and we're not using live weapons after last time."
	reward = 3000
	required_count = 3
...
/datum/bounty/item/security/techslugs
	name = "Tech Slugs"
	description = "The ICC Military Academy is conducting an ammo loading and use lessons, on the new 'Tech Slugs'. Problem is we don't have any, please fix this..."
	reward = 7500
	required_count = 15
...
/datum/bounty/item/security/WT550
	...
	description = "The ICC Military Academy's ammunition is running low, please send in spare ammo for practice."
	reward = 7500
	required_count = 5
...
/datum/bounty/item/security/pins
	...
	description = "The ICC Military Academy just got a new set of guns, sadly they didn't come with any pins. Can you send us some Test range locked firing pins?"
	reward = 5000
	required_count = 3
