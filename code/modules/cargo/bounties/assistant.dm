...
/datum/bounty/item/assistant/monkey_cubes
	name = "Monkey Cubes"
	description = "Due to a recent genetics accident, Head Office is in serious need of monkeys. Your mission is to ship monkey cubes."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/bonfire
	name = "Lit Bonfire"
	description = "Space heaters are malfunctioning and the cargo crew of Head Office is starting to feel cold. Ship a lit bonfire to warm them up."
	reward = 5000
...
/datum/bounty/item/assistant/corgimeat
	name = "Raw Corgi Meat"
	description = "The Syndicate recently stole all of Head Office's corgi meat. Ship out a replacement immediately."
	reward = 3000
