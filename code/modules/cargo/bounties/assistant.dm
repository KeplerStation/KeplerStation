/datum/bounty/item/assistant/strange_object
	name = "Strange Object"
	description = "Head Office has taken an interest in strange objects. Find one in maint, and ship it off to them right away."
	reward = 1200
	wanted_types = list(/obj/item/relic)

/datum/bounty/item/assistant/scooter
	name = "Scooter"
	description = "Head Office has determined walking to be wasteful. Ship a scooter to them to speed operations up."
...
/datum/bounty/item/assistant/skateboard
	name = "Skateboard"
	description = "Head Office has determined walking to be wasteful. Ship a skateboard to them to speed operations up."
...
/datum/bounty/item/assistant/soap
	name = "Soap"
	description = "Soap has gone missing from the Board of Director's bathrooms and nobody knows who took it. Replace it and be the hero Head Office needs."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/spear
	name = "Spears"
	description = "Head Office's security forces are going through budget cuts. You will be paid if you ship a set of spears."
	reward = 2000
	required_count = 5
...
/datum/bounty/item/assistant/toolbox
	name = "Toolboxes"
	description = "There's an absence of robustness at Head Office. Hurry up and ship some toolboxes as a solution."
	reward = 2000
	required_count = 6
...
/datum/bounty/item/assistant/statue
	name = "Statue"
	description = "Head Office would like to commision an artsy statue for the lobby. Ship one out, when possible."
	reward = 2000
...
/datum/bounty/item/assistant/cheesiehonkers
	...
	description = "Apparently the company that makes Cheesie Honkers is going out of business soon. Head Office wants to stock up before it happens!"
	reward = 1200
	required_count = 3
...
/datum/bounty/item/assistant/baseball_bat
	name = "Baseball Bat"
	description = "Baseball fever is going on at Head Office! Be a dear and ship them some baseball bats, so that management can live out their childhood dream."
	reward = 2000
	required_count = 5
...
/datum/bounty/item/assistant/donkpocket
	name = "Donk-Pockets"
	description = "Consumer safety recall: Warning. Donk-Pockets manufactured in the past year contain hazardous biomatter. Return units to Head Office immediately."
	reward = 3000
	required_count = 10
...
/datum/bounty/item/assistant/briefcase
	name = "Briefcase"
	description = "Horizons will be holding a business convention this year. Ship a few briefcases in support."
	reward = 2500
	required_count = 5
...
/datum/bounty/item/assistant/monkey_hide
	name = "Monkey Hide"
	description = "One of the scientists working for the ICC is interested in testing products on monkey skin. Your mission is to acquire monkey's hide and ship it."
	reward = 1500
...
/datum/bounty/item/assistant/comfy_chair
	name = "Comfy Chairs"
	description = "Director Pat is unhappy with his chair. He claims it hurts his back. Ship some alternatives out to humor him."
	reward = 1500
	required_count = 5
...
/datum/bounty/item/assistant/geranium
	name = "Geraniums"
	description = "Director Zot has the hots for his secretary, Zena. Send a shipment of geraniums - her favorite flower - and he'll happily reward you."
	reward = 4000
	required_count = 3
...
/datum/bounty/item/assistant/poppy
	name = "Poppies"
	description = "Director Zot really wants to sweep Security Officer Olivia off her feet. Send a shipment of Poppies - her favorite flower - and he'll happily reward you."
	reward = 1000
	required_count = 3
...
/datum/bounty/item/assistant/shadyjims
	name = "Shady Jim's"
	description = "There's an irate human resources agent at Head Officer demanding that he receive a box of Shady Jim's cigarettes. Please ship one. He's starting to make threats."
	reward = 500
	wanted_types = list(/obj/item/storage/fancy/cigarettes/cigpack_shadyjims)

/datum/bounty/item/assistant/potted_plants
	name = "Potted Plants"
	description = "Head Office is looking to commission a new BirdBoat-class station. You've been ordered to supply the potted plants."
	reward = 2000
	required_count = 8
...
/datum/bounty/item/assistant/handcuffs
	name = "Handcuffs"
	description = "A large influx of escaped convicts have arrived at Head Office. Now is the perfect time to ship out spare handcuffs (or restraints)."
	reward = 1000
	required_count = 5
...
/datum/bounty/item/assistant/monkey_cubes
	name = "Monkey Cubes"
	description = "Due to a recent genetics accident, the ICC is in serious need of monkeys. Your mission is to ship monkey cubes."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/chainsaw
	name = "Chainsaw"
	description = "The chef at Head Office is having trouble butchering her animals. She requests one chainsaw, please."
	reward = 2500
	wanted_types = list(/obj/item/twohanded/required/chainsaw)

/datum/bounty/item/assistant/ied
	name = "IED"
	description = "The ICC's maximum security prison is undergoing personnel training. Ship a handful of IEDs to serve as a training tools."
	reward = 2000
	required_count = 3
...
/datum/bounty/item/assistant/bonfire
	name = "Lit Bonfire"
	description = "Space heaters are malfunctioning and the cargo crew at Head Office is starting to feel cold. Ship a lit bonfire to warm them up."
	reward = 5000
...
/datum/bounty/item/assistant/corgimeat
	name = "Raw Corgi Meat"
	description = "The Syndicate recently stole all of the corgi meat. All of it. Ship out a replacement immediately."
	reward = 3000
...
/datum/bounty/item/assistant/tail_whip
	...
	description = "Director Jackson is looking for a fine addition to her exotic weapons collection. She will reward you handsomely for either a Cat or Liz o' Nine Tails."
	reward = 4000
