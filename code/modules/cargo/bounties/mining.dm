...
/datum/bounty/item/mining/basalt
	...
	description = "Head Office's Ash Walker exhibit needs to be expanded again, we just need some more basalt flooring."
	reward = 2200
	required_count = 60
...
/datum/bounty/item/mining/fruit
	name = "Cactus Fruit"
	description = "Head Office's Ash Walker habitat needs more fauna, send us some local fruit seeds!"
	reward = 1000
	required_count = 1
