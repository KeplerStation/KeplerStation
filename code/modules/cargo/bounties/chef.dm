/datum/bounty/item/chef/birthday_cake
	name = "Birthday Cake"
	description = "Horizons birthday is coming up! Ship Head Office a birthday cake to celebrate!"
	reward = 4000
...
/datum/bounty/item/chef/soup
	name = "Soup"
	description = "To quell the homeless uprising, Horizons will be serving soup to all underpaid workers. Ship any type of soup."
	reward = 3000
	required_count = 3
...
/datum/bounty/item/chef/chawanmushi
	name = "Chawanmushi"
	description = "Horizons wants to improve relations with its sister company, NotBritish Petroleum. Ship Chawanmushi immediately."
	reward = 8000
...
/datum/bounty/item/chef/soylentgreen
	name = "Soylent Green"
	description = "Head Office has heard wonderful things about the product 'Soylent Green', and would love to try some. If you endulge them, expect a pleasant bonus."
	reward = 5000
