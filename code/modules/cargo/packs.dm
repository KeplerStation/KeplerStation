...
/datum/supply_pack/service/janitor
	...
	desc = "Fight back against dirt and grime with NuClean's Janitorial Essentials(tm)! Contains three buckets, caution signs, and cleaner grenades. Also has a single mop, spray cleaner, rag, soap and a trash bag."
	cost = 1000
