...
/datum/game_mode/proc/send_intercept()
	if(flipseclevel && !(config_tag == "extended"))//CIT CHANGE - lets the security level be flipped roundstart
		...
		return
	var/intercepttext = "<b><i>Horizons Status Summary</i></b><hr>"
	intercepttext += "<b>Head Office has intercepted and partially decoded a Syndicate transmission with vital information regarding their movements. The following report outlines the most \
