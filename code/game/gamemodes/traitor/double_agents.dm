...
/datum/game_mode/traitor/internal_affairs/generate_report()
	return "Thank you for your relaying concerns about our internal affairs agents. Please proceed to an internal affairs agent to file \
			a report about any potential misconduct. Thank you!"
