...
/datum/game_mode/traitor/internal_affairs
	...
	reroll_friendly = 0
	traitor_name = "Internal Affairs Agent"
	...
	announce_text = "There are Internal Affairs Agents trying to kill each other!\n\
...
/datum/game_mode/traitor/internal_affairs/generate_report()
	return "We at Horizons take your concerns regarding misconduct by internal affairs agents seriously. For resolution to such a problem, we recommend speaking \
			with one of our many official internal affairs agents who are trained in conflict resolution."
