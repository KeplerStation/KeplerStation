...
/obj/item/book/manual/ripley_build_and_repair
	...
	dat = {"<html>
				...
				<li>Install the internal armor plating (Not included due to ICC regulations. Can be made using 5 metal sheets.)</li>
				<li>Secure the internal armor plating with a wrench</li>
				<li>Weld the internal armor plating to the chassis</li>
				<li>Install the external reinforced armor plating (Not included due to ICC regulations. Can be made using 5 reinforced metal sheets.)</li>
				...
				<li>The ICC is determined to provide for the safety of its <s>investments</s> employees.</li>
				</ol>
				</body>
				</html>
...
/obj/item/book/manual/nuclear
	...
	dat = {"<html>
			...
			Intelligence Analysts believe that normal procedure is for the Captain to secure the nuclear authorisation disk.<br>
			Good luck!
			</html>"}
