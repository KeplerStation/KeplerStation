...
/obj/effect/mob_spawn/human/hermit/Initialize(mapload)
	...
	switch(arrpee)
		...
		if(2)
			...
			outfit.back = /obj/item/storage/backpack
		if(3)
			flavour_text += "you were a doctor on a space stations, but you left behind that damn corporation's tyranny and everything it stood for. From a metaphorical hell \
		...
		if(4)
			...
			at a state-of-the-art research facility, were in one of the escape pods alone and saw the red button. It was big and shiny, and it caught your eye. You pressed \
...
/obj/effect/mob_spawn/human/prisoner_transport
	...
	roundstart = FALSE
	death = FALSE
	flavour_text = "<b>Good. It seems as though your ship crashed. <span class='big bold'>You're a prisoner,</span> sentenced to hard work in one of the ICC's labor camps, but it seems as \
	though fate has other plans for you. You remember that you were convicted of "
	assignedrole = "Escaped Prisoner"

/obj/effect/mob_spawn/human/prisoner_transport/special(mob/living/L)
	L.real_name = "ICCT #LL-0[rand(111,999)]"
	L.name = L.real_name
...
/obj/effect/mob_spawn/human/oldsec
	...
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span class='big bold'>You are a security officer,</span><b> stationed onboard a state of the art research station. You vaguely recall rushing into a \
...
/obj/effect/mob_spawn/human/oldeng
	...
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span class='big bold'>You are an engineer</span><b> stationed onboard a state of the art research station. You vaguely recall rushing into a \
	cryogenics pod due to an oncoming radiation storm. The last thing you remember is the station's Artificial Program telling you that you would only be asleep for eight hours. As you open \
	your eyes, everything seems rusted and broken, a dark feeling swells in your gut as you climb out of your pod. \
	Work as a team with your fellow survivors and do not abandon them.</b>"
...
/obj/effect/mob_spawn/human/oldsci
	...
	random = TRUE
	mob_species = /datum/species/human
	flavour_text = "<span class='big bold'>You are a scientist</span><b> stationed onboard a state of the art research station. You vaguely recall rushing into a \
	cryogenics pod due to an oncoming radiation storm. The last thing you remember is the station's Artificial Program telling you that you would only be asleep for eight hours. As you open \
	your eyes, everything seems rusted and broken, a dark feeling swells in your gut as you climb out of your pod. \
	Work as a team with your fellow survivors and do not abandon them.</b>"
...
>>>>>>> 637e26eec9... Merge pull request #10547 from Putnam3145/one-more-dojo-tweak
