...
/obj/structure/showcase/fakeid
	name = "\improper Head Office identification console"
...
/obj/structure/showcase/fakesec
	name = "\improper Head Office security records"
...
/obj/structure/showcase/machinery/microwave
	name = "corporate brand microwave"
	desc = "The age-old microwave, the multi-purpose cooking appliance every station needs! This one appears to be drawn onto a cardboard box."
...
/obj/structure/showcase/perfect_employee
	...
	desc = "A stand with a model of the perfect Employee bolted to it. Signs indicate it is robustly genetically engineered, as well as being ruthlessly loyal."
