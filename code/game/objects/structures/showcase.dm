...
/obj/structure/showcase/fakeid
	name = "\improper Horizons identification console"
...
/obj/structure/showcase/fakesec
	name = "\improper Horizons security records"
...
/obj/structure/showcase/machinery/microwave
	name = "EasyClean-brand microwave"
	desc = "The famous EasyClean-brand microwave, the multi-purpose cooking appliance every station needs! This one appears to be drawn onto a cardboard box."
...
/obj/structure/showcase/perfect_employee
	...
	desc = "A stand with a model of the perfect Horizons Employee bolted to it. Signs indicate it is robustly genetically engineered, as well as being ruthlessly loyal."
