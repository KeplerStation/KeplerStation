...
<th>Time Added</th>
			...
			if("Print Poster")
				if(!( printing ))
					...
					if(wanted_name)
						var/default_description = "A poster declaring [wanted_name] to be a dangerous individual, wanted by Head Office. Report any sightings to security immediately."
