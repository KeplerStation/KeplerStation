...
/datum/game_mode/gang/generate_report()
	return "Cybersun Industries representatives claimed that they, in joint research with the Tiger Cooperative, have made a major breakthrough in brainwashing technology, and have \
			...
			months to come due to its flaws, they reported some as missing but passed it off to carelessness. At Head Office, we don't like mysteries, and we have reason to believe that this \
			technology was stolen for revolutionary use. Be on the lookout for territory claims and unusually violent crew behavior, applying mindshield implants as necessary."
