...
/datum/controller/subsystem/ticker/proc/generate_individual_objectives(var/datum/mind/crewMind)
	...
	to_chat(crewMind, "<B>As a part of Horizons anti-tide efforts, you have been assigned an optional objective. It will be checked at the end of the shift. <font color=red>Performing traitorous acts in pursuit of your objective may result in termination of your employment.</font></B>")
	to_chat(crewMind, "<B>Your optional objective:</B> [newObjective.explanation_text]")

/datum/objective/crew/
	var/jobs = ""
	explanation_text = "File a report on the GitHub if this ever shows up. Something just broke here, dude"
