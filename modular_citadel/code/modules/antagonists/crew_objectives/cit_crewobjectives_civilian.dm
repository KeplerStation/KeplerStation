...
/datum/objective/crew/foodhoard
	...
	explanation_text = "Something broke. Report this on the GitHub w/ error code #84373."
	jobs = "cook"
...
/datum/objective/crew/foodhoard/update_explanation_text()
	. = ..()
	explanation_text = "Personally deliver at least [target_amount] [initial(foodpath.name)]s to Head Office."
